...
# 88 "/opt/microchip/xc8/v2.10/avr/avr/include/avr/pgmspace.h" 3
...
# 89 "/opt/microchip/xc8/v2.10/avr/avr/include/avr/pgmspace.h" 2 3
...
# 91 "/opt/microchip/xc8/v2.10/avr/avr/include/avr/pgmspace.h" 2 3
...
# 3 "usb/descriptors.c" 2

const USB_DeviceDescriptor 
# 4 "usb/descriptors.c" 3
...
const ConfigDesc 
# 33 "usb/descriptors.c" 3
                __attribute__((__progmem__)) 
# 33 "usb/descriptors.c"
...
const USB_StringDescriptor 
# 73 "usb/descriptors.c" 3
                          __attribute__((__progmem__)) 
# 73 "usb/descriptors.c"
                                  language_string = {
 .bLength = (sizeof(USB_DescriptorHeader) + ((1) * 2)),
 .bDescriptorType = USB_DTYPE_String,
 .bString = {0x0409},
};

const USB_StringDescriptor 
# 79 "usb/descriptors.c" 3
                          __attribute__((__progmem__)) 
# 79 "usb/descriptors.c"
                                  manufacturer_string = {
 .bLength = (sizeof(USB_DescriptorHeader) + ((13) * 2)),
 .bDescriptorType = USB_DTYPE_String,
 .bString = u"Nonolith Labs"
};

const USB_StringDescriptor 
# 85 "usb/descriptors.c" 3
                          __attribute__((__progmem__)) 
# 85 "usb/descriptors.c"
                                  product_string = {
 .bLength = (sizeof(USB_DescriptorHeader) + ((14) * 2)),
 .bDescriptorType = USB_DTYPE_String,
...
uint16_t usb_cb_get_descriptor(uint8_t type, uint8_t index, const uint8_t** ptr) {
 const void* address = 
# 93 "usb/descriptors.c" 3 4
                      ((void *)0)
# 93 "usb/descriptors.c"
                          ;
 uint16_t size = 0;
 ...
 switch (type) {
  ...
  case USB_DTYPE_String:
   ...
   size = 
# 117 "usb/descriptors.c" 3
         (__extension__({ uint16_t __addr16 = (uint16_t)((uint16_t)(
# 117 "usb/descriptors.c"
         &((USB_StringDescriptor*)address)->bLength
# 117 "usb/descriptors.c" 3
...
# 129 "usb/descriptors.c" 3 4
_Bool 
# 129 "usb/descriptors.c"
    usb_cb_set_configuration(uint8_t config) {
 if (config <= 1) {
  return 
# 131 "usb/descriptors.c" 3 4
        1
# 131 "usb/descriptors.c"
            ;
 } else {
  return 
# 133 "usb/descriptors.c" 3 4
        0
# 133 "usb/descriptors.c"
             ;
 }
}
...
# 153 "usb/descriptors.c" 3 4
_Bool 
# 153 "usb/descriptors.c"
    usb_cb_set_interface(uint16_t interface, uint16_t altsetting) {
 return 
# 154 "usb/descriptors.c" 3 4
       0
# 154 "usb/descriptors.c"
            ;
}
