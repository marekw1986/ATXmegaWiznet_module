...
# 15 "fatfs/diskio.c" 2
# 1 "fatfs/../time/time.h" 1
# 13 "fatfs/../time/time.h"
...
)
{
 switch (pdrv) {
        case 0:
            if (SDStatus & 0x02) return 0x01;
            if (sd_init() == 0) SDStatus &= ~0x01;
            return SDStatus;
 }
 return 0x01;
}
...
)
{
 switch (pdrv) {
        case 0:
            ...
            if (SDStatus & 0x01) {return RES_NOTRDY;}
 }
